package com.example.inditex.domain.error.handlers;


import com.example.inditex.domain.enums.ErrorDefinitionEnum;
import com.example.inditex.domain.error.exceptions.BaseException;
import com.example.inditex.domain.model.ErrorResponse;
